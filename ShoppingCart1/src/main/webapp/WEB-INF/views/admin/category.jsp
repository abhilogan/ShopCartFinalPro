		...
		<table border="5" bgcolor="cyan">
			...
			<c:forEach var="category" items="${categories}">
				<tr>
					...
					<td><a href="${pageContext.request.contextPath}/category/delete/?id=${category.id}">Delete</a></td>

					<td><a href="${pageContext.request.contextPath}/category/edit/?id=${category.id}">Edit</a></td>
