...
<body>
	<form:form name="registration" modelAttribute="user"
		action="registration" method="post" style="border: 1px solid #ccc"
		onsubmit="return matchpass()">
		<div class="container">
			<center>
				<img alt=""
					src="C:\Users\lenovo\eclipse-workspace\LoginApp2\ShoppingCart1\src\main\webapp\resources\images\signup.PNG"
					width="72" height="72">
				<h1>Sign Up</h1>
				<p class="lead">Please fill all Details Properly</p>
			</center>
			<hr>
			...
			<form:input type="text" path="emailID" placeholder="Enter Email"
				name="email" required="" />
			...
			<label for="psw_repeat"><b>Repeat Password</b></label> <input
				type="password" placeholder="Repeat Password" name="psw_repeat"
				required=""> <label for="mob"><b>Mobile number</b></label>
			<form:input type="text" name="mob" path="mobile"
				placeholder="Enter mobile no" maxlength="10" required="" />
			<form:hidden path="role" value="C" />
			<div class="clearfix">
