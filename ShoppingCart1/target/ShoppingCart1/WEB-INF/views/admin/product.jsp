	...
	<form action="${pageContext.request.contextPath}/product/save/" method="post" enctype="multipart/form-data">
		<table>
			...
			<tr>
				...
				</select> <!-- <input type="text" name="supplierID" /> --></td>
			</tr>
			...
			<tr>
				...
				<td><input type="submit" value='create product'><br></td>
		...
		<table border="5" bgcolor="cyan">
			...
			<c:forEach var="product" items="${products}">
				<tr>
					...
					<td><a href="${pageContext.request.contextPath}/product/delete/?id=${product.id}">Delete</a></td>

					<td><a href="${pageContext.request.contextPath}/product/edit/?id=${product.id}">Edit</a></td>
