...
<body>
	...
	<center>
	<img alt="" src="C:\Users\lenovo\eclipse-workspace\LoginApp2\ShoppingCart1\src\main\webapp\resources\images\mycart.PNG" width="72" height="72">
	<img alt="" src="C:\Users\lenovo\eclipse-workspace\LoginApp2\ShoppingCart1\src\main\webapp\resources\images\mycart2.PNG" width="72" height="72">
	...
	<div class="container">
		...
		<form action="checkout" method="post">
			...
			<a href="${pageContext.request.contextPath}/continueShopping"> <span
				class="glyphicon glyphicon-arrow-left"></span> Continue Shopping
			</a> <a href="${pageContext.request.contextPath}/checkout"><ul
					class="nav navbar-nav navbar-right">
					<span class="glyphicon glyphicon-play"></span> Check-Out</a>
